...
@section('title', 'Welcome to Sharif Rony')
...
@section('main_content')
    ...
    <section class="flex flex-col gap-8 xl:col-span-8">
        ...
        @forelse ($posts as $post)
            <article
                ...
                <div class="flex items-center gap-2">
                    ...
                    src="https://avatars.githubusercontent.com/u/37629029?v=4" alt="Sharif Rony" />
        ...
        @empty
            <h3 class="mb-4 text-white text-xl font-bold md:text-4xl hover:underline decoration-emerald-700">
                  Not Found!!!
            </h3>
        @endforelse
